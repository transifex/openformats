...
class DumbXmlTestCase(unittest.TestCase):
    def test_no_embeds(self):
        cases = (
            ...
            ('<a/ >', 0, 'a', [], {}, None, None, None, None, 5, '', 5),
            ('<a/> tail', 0, 'a', [], {}, None, None, None, None, 4, ' tail',
             9),
            ('<a b="c" d:e="f"/>', 0, 'a',
             [(3, 'b', 6, "c"), (9, 'd:e', 14, "f")], {'b': "c", 'd:e': "f"},
             None, None, None, None, 18, '', 18),
            ('<a b="c" d="e" />', 0, 'a',
             [(3, 'b', 6, "c"), (9, 'd', 12, "e")], {'b': "c", 'd': "e"}, None,
             None, None, None, 17, '', 17),
            ('<a b="c/d" e="f"/>', 0, 'a',
             [(3, 'b', 6, "c/d"), (11, 'e', 14, "f")], {'b': "c/d", 'e': "f"},
             None, None, None, None, 18, '', 18),
            ('<a b="c>d" e="f"/>', 0, 'a',
             [(3, 'b', 6, "c>d"), (11, 'e', 14, "f")], {'b': "c>d", 'e': "f"},
             None, None, None, None, 18, '', 18),
            ...
            ('<a b="c"></a> tail', 0, 'a', [(3, 'b', 6, "c")], {'b': "c"}, 9,
             '', '', 9, 13, ' tail', 18),
            ('<a>hello world</a>', 0, 'a', [], {}, 3, 'hello world',
             'hello world', 14, 18, '', 18),
            ('<a>hello <![CDATA[</a>]]></a>', 0, 'a', [], {}, 3,
             'hello <![CDATA[</a>]]>', 'hello <![CDATA[</a>]]>', 25, 29, '',
             29),
            ('<a>hello world</a> tail', 0, 'a', [], {}, 3, 'hello world',
             'hello world', 14, 18, ' tail', 23),
            ('<a b="c">hello world</a> tail', 0, 'a', [(3, 'b', 6, "c")],
             {'b': "c"}, 9, 'hello world', 'hello world', 20, 24, ' tail', 29),
        )
        for case in cases:
    ...
    def test_one_child(self):
        cases = (
            ...
            ('<r><a:b/></r>', '<a:b/>', 9, 3, 'a:b', [], {}, None, None, 9, '',
             9),
            ('<r> <a/></r>', ' <a/>', 8, 4, 'a', [], {}, None, None, 8, '', 8),
            ('<r><a /></r>', '<a />', 8, 3, 'a', [], {}, None, None, 8, '', 8),
            ('<r><a/ ></r>', '<a/ >', 8, 3, 'a', [], {}, None, None, 8, '', 8),
            ('<r><a/> tail</r>', '<a/> tail', 12, 3, 'a', [], {}, None, None,
             7, ' tail', 12),
            ('<r><a b="c" d:e="f"/></r>', '<a b="c" d:e="f"/>', 21, 3, 'a',
             [(6, 'b', 9, "c"), (12, 'd:e', 17, "f")], {'b': "c", 'd:e': "f"},
             None, None, 21, '', 21),
            ('<r><a b="c" d="e" /></r>', '<a b="c" d="e" />', 20, 3, 'a',
             [(6, 'b', 9, "c"), (12, 'd', 15, "e")], {'b': "c", 'd': "e"},
             None, None, 20, '', 20),
            ('<r><a b="c/d" e="f"/></r>', '<a b="c/d" e="f"/>', 21, 3, 'a',
             [(6, 'b', 9, "c/d"), (14, 'e', 17, "f")], {'b': "c/d", 'e': "f"},
             None, None, 21, '', 21),
            ('<r><a b="c>d" e="f"/></r>', '<a b="c>d" e="f"/>', 21, 3, 'a',
             [(6, 'b', 9, "c>d"), (14, 'e', 17, "f")], {'b': "c>d", 'e': "f"},
             None, None, 21, '', 21),
            ...
            ('<r><!-- hello there --> tail</r>', '<!-- hello there --> tail',
             28, 3, NewDumbXml.COMMENT, [], {}, 7, ' hello there ', 23,
             ' tail', 28),

            # With content
            ('<r><a></a></r>', '<a></a>', 10, 3, 'a', [], {}, 6, '', 10, '',
             10),
            ('<r><a></a> tail</r>', '<a></a> tail', 15, 3, 'a', [], {}, 6, '',
             10, ' tail', 15),
            ('<r><a b="c"></a> tail</r>', '<a b="c"></a> tail', 21, 3, 'a',
             [(6, 'b', 9, "c")], {'b': "c"}, 12, '', 16, ' tail', 21),
            ...
            ('<r><a b="c">hello world</a> tail</r>',
             '<a b="c">hello world</a> tail', 32, 3, 'a', [(6, 'b', 9, "c")],
             {'b': "c"}, 12, 'hello world', 27, ' tail', 32),
        )
        for case in cases:
