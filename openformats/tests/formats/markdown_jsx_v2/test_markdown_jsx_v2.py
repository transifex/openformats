...
from openformats.formats.markdown_jsx_v2 import MarkdownJsxHandler_v2
from openformats.tests.formats.common import CommonFormatTestMixin


class MarkdownJsxV2TestCase(CommonFormatTestMixin, unittest.TestCase):
    """Tests the basic functionality of MarkdownJsxHandler_v2."""
    HANDLER_CLASS = MarkdownJsxHandler_v2
    TESTFILE_BASE = "openformats/tests/formats/markdown_jsx_v2/files"

    def __init__(self, *args, **kwargs):
        super(MarkdownJsxV2TestCase, self).__init__(*args, **kwargs)
